    ...
    <section class="content content-first beige">
      <div class="content__container container">
        ...
        <div class="section-desc">
          ...
          <p class="section-desc__txt">Богатый опыт и научные знания по разведению и селекции орехоплодных деревьев, других кустарников и цветов позволяют предоставлять Вам продукцию самого высокого качества. В нашем <a href="https://disk.yandex.ru/i/FkFwMaUgC1F94A" target="_blank">каталоге</a> Вы найдете наиболее приспособленные сорта растений для посадки в средней полосе России и цены на них. На протяжении всего года <a href="/#contacts">Вы можете заказать саженцы</a> грецкого ореха, других орехоплодных и других культур.</p>
